...
const AddProductDescription = () => {
  ...
  const isValidateReqFields = () => {
    const newErrors = { name: "", category: "", brand: "" };
    let isValid = true;

    if (oneProductDescription.name.trim() === "") {
      newErrors.name = "Product name is required.";
      isValid = false;
    }
    if (oneProductDescription.category.trim() === "") {
      newErrors.category = "Category is required.";
      isValid = false;
    }
    if (oneProductDescription.brand.trim() === "") {
  ...
  const handleoneProductDescription = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (setTempProductObj) {
      setTempProductObj({
        ...
        image: oneProductDescription.image || "/assets/photos/emptyImg.png",
      });
    }
      ...
      <div className="card bg-base-100 max-w-[500px] shadow-[0px_0px_20px_-2px_rgba(0,0,0,0.1)] mt-2">
        <div className="card-body p-5">
          ...
          <div className="form-control">
            ...
            />
            {errors.name && <p className="text-[#EE2A2A] text-xs font-myFontWorksans font-normal mt-1">{errors.name}</p>}
          </div>
          ...
          <div className="form-control">
            ...
            {errors.category && <p className="text-[#EE2A2A] text-xs font-myFontWorksans font-normal mt-1">{errors.category}</p>}
          </div>
          ...
          <div className="form-control">
            ...
            <input
              ...
              onChange={handleInput}
            />
            {errors.brand && <p className="text-[#EE2A2A] text-xs font-myFontWorksans font-normal mt-1">{errors.brand}</p>}
          </div>
          {/*---------------------file upload --------------------- */}
