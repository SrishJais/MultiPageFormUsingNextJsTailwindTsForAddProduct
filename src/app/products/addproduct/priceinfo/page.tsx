  ...
  const handlePriceInfo = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (
      ...
      setError((prev) => ({
        ...prev,
        finalError:
          "Please fill in all the form page before final submit",
      }));
      ...
      <div className="card bg-base-100 shadow-[0px_0px_20px_-2px_rgba(0,0,0,0.1)] mt-2">
        <div className="card-body p-5">
          ...
          <div className="form-control relative">
            ...
            <input
              ...
              onChange={(e) =>
                setOnePriceInfoData({
                  ...onePriceInfoData,
                  priceInr: e.target.value === "" ? null : Number(e.target.value), //e.target.value is of string only in any input
                })
              }
            />
          </div>
          {error.priceError && (
            <div className="text-[#EE2A2A] text-xs font-myFontWorksans font-normal mt-1">{error.priceError}</div>
          )}
                ...
                onChange={(e) =>
                  setOnePriceInfoData({
                    ...
                    discount: {
                      ...
                      value: e.target.value === "" ? null : Number(e.target.value), // Update the discount value
                    },
                  })
                }
              />
          ...
          {error.discountValueError && (
            <div className="text-[#EE2A2A] text-xs font-myFontWorksans font-normal mt-1">{error.discountValueError}</div>
          )}
        </div>
        {error.finalError && (
